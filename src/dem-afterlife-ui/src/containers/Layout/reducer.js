...
import { getNavigationLinkArrayApi, getSocialMediaLinkArrayApi } from "api";
...
export const getNavigationLinkArray = () => ({
  type: GET_NAVIGATION_LINK_ARRAY
});

export const GET_NAVIGATION_LINK_ARRAY_SUCCESS =
...
export const getSocialMediaLinkArray = () => ({
  type: GET_SOCIAL_MEDIA_LINK_ARRAY
});

export const GET_SOCIAL_MEDIA_LINK_ARRAY_SUCCESS =
...
export const layoutSaga = function*() {
  yield all([getNavigationLinkArraySaga(), getSocialMediaLinkArraySaga()]);
};
