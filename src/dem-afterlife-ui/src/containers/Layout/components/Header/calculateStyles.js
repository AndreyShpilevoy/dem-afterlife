...
const constructMediaModelForCurrentSize = (
  gridSize,
  mediaMinString,
  mediaMaxString,
  headerStyles
  ...
  createMediaQueryMinMax(mediaMinString, mediaMaxString, {
    header: {
      ...getCommonHeaderStyle(gridSize, headerStyles),
      ...getSpecificStyle(gridSize)(gridSize, headerStyles)
    },
    ...
    navigationLinksContainer: getNavigationLinksContainerStyle(
      gridSize,
      headerStyles
    ),
