...
export class HeaderPure extends Component {
  ...
  render() {
    ...
    const headerClassName = concatStyleNames([
      header,
      shrinkedHeader ? "shrinkedHeader" : ""
    ]);
    const headerLogoContainerClassName = concatStyleNames([
      headerLogoContainer,
      shrinkedHeader ? "shrinkedHeader" : ""
    ]);
    const navigationLinksContainerClassName = concatStyleNames([
      headerColumn,
      navigationLinksContainer,
      menuIsClosed ? "closed" : ""
    ]);
          ...
          <div className={headerClassName}>
            <Row>
              ...
              <Column
                ...
                lg={8}
                xl={9}
                className={navigationLinksContainerClassName}
              >
                <NavigationLinkList
...
export default injectSheet(calculateStyles, { componentName: "Header" })(
  HeaderPure
);
