...
export const GET_FORUM_ARRAY_BY_CHAPTER_ID_ARRAY =
...
export const GET_FORUM_ARRAY_BY_CHAPTER_ID_ARRAY_SUCCESS =
...
export const GET_FORUM_ARRAY_BY_PARENT_FORUM_ID =
  "GET_FORUM_ARRAY_BY_PARENT_FORUM_ID";
export const getForumArrayByParentForumId = parentForumId => ({
  type: GET_FORUM_ARRAY_BY_PARENT_FORUM_ID,
  payload: { parentForumId }
});

export const GET_FORUM_ARRAY_BY_PARENT_FORUM_ID_SUCCESS =
  "GET_FORUM_ARRAY_BY_PARENT_FORUM_ID_SUCCESS";
export const getForumArrayByParentForumIdSuccess = forumArray => ({
  type: GET_FORUM_ARRAY_BY_PARENT_FORUM_ID_SUCCESS,
  payload: { forumArray }
});

export const GET_SUB_FORUM_ARRAY_BY_PARENT_FORUM_ID_ARRAY =
...
export const GET_SUB_FORUM_ARRAY_BY_PARENT_FORUM_ID_ARRAY_SUCCESS =
...
export const getSubForumsByParentForumIdArrayNonBlockSaga = function*(
  parentForumIdArray
) {
  const { response, error } = yield call(
    getSubForumArrayByParentForumIdArrayApi,
...
export const SET_PAGINATION_TOTAL_ITEMS_COUNT =
