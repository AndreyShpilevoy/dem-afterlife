...
import { getChapterArrayApi, getLastActiveTopicArrayApi } from "api";
...
export const getLastActiveTopicArray = () => ({
  type: GET_LAST_ACTIVE_TOPICS_ARRAY
});

export const GET_LAST_ACTIVE_TOPICS_ARRAY_SUCCESS =
...
export const conferenceSaga = function*() {
  yield all([getChapterArraySaga(), getLastActiveTopicArraySaga()]);
};
