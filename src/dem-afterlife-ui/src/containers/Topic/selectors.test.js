...
describe("Topic selectors", () => {
  ...
  it("userArraySelector should return expected array", () => {
    const state = {
      topicReducer: { userArray: [{ id: 1 }, { id: 3 }, { id: 2 }] }
    };
  ...
  it("postArrayWithMappedUserSelector without editInfo should return expected array", () => {
    ...
    const expectedResult = [
      {
        id: 1,
        postTime: new Date("2015/08/17 13:42:32"),
        userId: 1,
        user: { id: 1 }
      },
      {
        id: 3,
        postTime: new Date("2017/08/17 13:42:32"),
        userId: 2,
        user: { id: 2 }
      },
      {
        id: 2,
        postTime: new Date("2016/08/17 13:42:32"),
        userId: 1,
        user: { id: 1 }
      }
    ];
