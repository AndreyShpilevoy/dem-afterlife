...
describe("CoubVideo", () => {
  ...
  it("should return valid result if pass iframe html code", () => {
    expect(
      coubVideo(
        '<iframe style="vertical-align: bottom; width: 640px; height: 360px;" width="640" height="360" src="https://coub.com/embed/9fu9z" webkitallowfullscreen mozallowfullscreen allowfullscreen frameborder="0"></iframe>'
      )
    ).toMatchSnapshot();
  });
