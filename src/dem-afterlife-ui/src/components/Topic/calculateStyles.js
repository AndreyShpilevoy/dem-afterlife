...
const getLastPostInfoStyleMdMax = size =>
  createMediaQueryMax(size, { flexDirection: "row" });
const getLastPostInfoStyleSmMax = (mediaSize, fontSize) =>
  createMediaQueryMax(mediaSize, { justifyContent: "left", fontSize });
const getTextSizeMax = (mediaSize, fontSize) =>
  createMediaQueryMax(mediaSize, { fontSize });
const getPaginationHeight = mediaSize =>
  createMediaQueryMax(mediaSize, { height: 0 });
