...
const classes = {
  ...
  ".default-Topic-parentForumTitleStyle:hover":
    "default-Topic-parentForumTitleStyle:hover",
  ".default-Topic-parentForumTitleStyle:visited":
    "default-Topic-parentForumTitleStyle:visited",
  ".default-Topic-parentForumTitleStyle:visited:hover":
    "default-Topic-parentForumTitleStyle:visited:hover",
  ".default-Topic-wrapper:last-child": "default-Topic-wrapper:last-child",
  ".default-Topic-wrapper:last-child>.default-Topic-separator":
    "default-Topic-wrapper:last-child>.default-Topic-separator",
