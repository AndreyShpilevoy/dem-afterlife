...
const classes = {
  ".default-Forum-lastTopicInfoWrapper>div":
    "default-Forum-lastTopicInfoWrapper>div",
  ".default-Forum-mainContainer:last-child":
    "default-Forum-mainContainer:last-child",
  ".default-Forum-mainContainer:last-child>.default-Forum-separator":
    "default-Forum-mainContainer:last-child>.default-Forum-separator",
...
describe("ForumPure", () => {
  it("component match expected snapshot without subForumArray", () => {
    const forum = {
      ...
      description:
        "Вопросы по созданию моделей, конвертированию в игру и всего что с этим связано.",
      topicsCount: 4,
      postsCount: 864,
      lastTopicInfo: {
        topicId: 4,
    ...
    expect(
      shallow(
        <ForumPure className="forumClassName" classes={classes} forum={forum} />
      )
    ).toMatchSnapshot();
  });
