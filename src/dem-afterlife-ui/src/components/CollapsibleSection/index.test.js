...
describe("CollapsibleSection Pure", () => {
  const classes = {
    ".default-CollapsibleSection-bodyHolder.closed":
      "default-CollapsibleSection-bodyHolder.closed",
    ".default-CollapsibleSection-headerArrow > .SVGInline-svg":
      "default-CollapsibleSection-headerArrow > .SVGInline-svg",
    ".default-CollapsibleSection-headerArrow.closed":
      "default-CollapsibleSection-headerArrow.closed",
  ...
  it("without headerSettings", () => {
    expect(
      shallow(
        <CollapsibleSectionPure classes={classes}>
