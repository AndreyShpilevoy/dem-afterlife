const ua = [
  {id: 1, value: 'Тем', description: 'for topics count in %ForumName% on forum component'},
  {id: 2, value: 'Повідомлень', description: 'for posts count in %ForumName% on forum component'},
  {id: 3, value: 'Останнє повідомлення', description: 'for last message in %TopicName% on forum component'},
