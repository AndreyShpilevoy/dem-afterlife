...
describe('Container calculateStyles', () => {
    ...
    it('should create expected object', () => {
        const expectedResult = {
            '@media (min-width: 0px) and (max-width: 575px)': {container: {marginLeft: 'auto', marginRight: 'auto', width: '100%'} },
            '@media (min-width: 576px) and (max-width: 767px)': {container: {marginLeft: 'auto', marginRight: 'auto', width: '540px'} }
        };
