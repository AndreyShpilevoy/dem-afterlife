...
import {createMediaQueryMin, createMediaQueryMax, createMediaQueryMinMax, mergeTwoArraysOfObjectMatchById, stringIsLink, stringIsEmail} from './index';
...
describe('Utils', () => {
    ...
    it('mergeTwoArraysOfObjectMatchById should create expected object', () => {
        ...
        const secondArray = [{id: 1, title: 'Not ok'}, {id: 3, title: 'Not ok'}];
        const expectedResult = [{id: 2, title: 'Ok'}, {id: 1, title: 'Not ok'}, {id: 3, title: 'Not ok'}];
        expect(mergeTwoArraysOfObjectMatchById(firstArray, secondArray)).toEqual(expectedResult);
    });

    it('stringIsLink should return true on valid link', () => {
        expect(stringIsLink('http://facebook.github.io/jest/docs/expect.html')).toBeTruthy();
    });
