const ru = [
    ...
    {id: 2, value: 'Сообщений', description: 'for posts count in %ForumName% on forum component'},
    {id: 3, value: 'Последнее сообщение', description: 'for last message in %TopicName% on forum component'},
