...
const LastActiveTopicArrayApi = () => new Promise(resolve => {
    setTimeout(() => {
        const result = [
            {...topicArray[0], ...{forumId: 10, parentForumTitle: 'Общие вопросы'} },
            {...topicArray[1], ...{forumId: 20, parentForumTitle: 'Технические вопросы'} },
            {...topicArray[2], ...{forumId: 30, parentForumTitle: 'Обсуждение модификаций'} },
