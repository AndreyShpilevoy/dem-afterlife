...
describe('HTML5VideoAudioTags', () => {
    it('should return valid result if pass Audio link', () => {
        expect(HTML5VideoAudioTags('http://www.w3schools.com/tags/horse.mp3')).toMatchSnapshot();
    });

    it('should return valid result if pass Video link', () => {
        expect(HTML5VideoAudioTags('http://www.w3schools.com/html/mov_bbb.mp4')).toMatchSnapshot();
    });
